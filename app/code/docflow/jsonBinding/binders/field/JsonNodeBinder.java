 ...
 */
public final class JsonNodeBinder extends JsonTypeBinder.FieldAccessor {

    public JsonNodeBinder(Field fld, Method getter, Method setter, String fldName) {
    ...
    public void copyFromJson(final Object obj, final JsonNode node, DocumentAccessActionsRights rights, BitArray mask,
        ...
        final JsonNode t = (JsonNode) getter.invoke(obj);

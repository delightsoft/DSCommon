 ...
 */
public final class UUIDBinder extends JsonTypeBinder.FieldAccessor {
    public UUIDBinder(Field fld, Method getter, Method setter, String fldName) {
    ...
    public void copyFromJson(final Object obj, final JsonNode node, DocumentAccessActionsRights rights, BitArray mask,
        ...
        if (node.isNull()) {
            ...
            try {
                v = UUID.fromString(node.asText());
            } catch (IllegalArgumentException e) {
                result.addMsg(DocflowMessages.error_ValidationFieldIncorrectValue_2, fldPrefix + fldName, v);
                return;
            }
        }

        final UUID t = (UUID) getter.invoke(obj);
    ...
    public void copyToJson(Object obj, Template template, ObjectNode out, Stack<String> stack, int mode, DocumentAccessActionsRights rights, BitArray mask) throws Exception {
        final UUID v = (UUID) getter.invoke(obj);

 ...
 */
public final class IntervalBinder extends JsonTypeBinder.FieldAccessor {
    ...
    public IntervalBinder(Field fld, Method getter, Method setter, String fldName) {
    ...
    public void copyFromJson(final Object obj, final JsonNode node,
        ...
        // TODO: Impl
//        final Interval t = (Interval) getter.invoke(obj);
//        final Interval vDate = (v == null) ? null : new Interval(v);
...
//        final Interval v = (Interval) getter.invoke(obj);
//        if (v == null)
//            out.putNull(fldName);
//        else

 ...
 */
public final class DurationBinder extends JsonTypeBinder.FieldAccessor {
    ...
    public DurationBinder(Field fld, Method getter, Method setter, String fldName) {
    ...
    public void copyFromJson(final Object obj, final JsonNode node,
        ...
        final Duration t = (Duration) getter.invoke(obj);
        final Duration vDate = (v == null) ? null : new Duration((long) v);
    ...
    public void copyToJson(final Object obj, Template template, final ObjectNode out, Stack<String> stack, int mode, DocumentAccessActionsRights rights, BitArray mask)
            throws Exception {
        final Duration v = (Duration) getter.invoke(obj);
        if (v == null)
            out.putNull(fldName);
        else

...
nv.models = nv.models || {}; //stores all the possible docs/components
...
window.nv.docs.tooltip is the updated,new way to render tooltips.
...
(function() {
  ...
  /* Model which can be instantiated to handle tooltip rendering.
    Example usage: 
    var tip = nv.docs.tooltip().gravity('w').distance(23)
                .data(myDataObject);
...
/*
Snippet of code you can insert into each nv.docs.* to give you the ability to
do things like:
chart.options({
  showXAxis: true,
  tooltips: true
